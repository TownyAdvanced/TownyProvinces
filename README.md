...
1. Assess suitability for map:
   ...
   - At this time, townyProvinces does not work as well on "Historical" maps, such as "Earth". The main reason is because players on those maps often seek to build in historical locations, and province lines can cut through some of these locations. Features are in the ticket list to enable manual map tweaking and drawing.

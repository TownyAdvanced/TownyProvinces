...
public class LandValidationTask extends BukkitRunnable {
	...
	public static LandValidationTask landValidationJob = null;
	
	public static LandValidationTask getLandValidationJob() {
		return landValidationJob;
	}
	
	private LandValidationJobStatus landValidationJobStatus;
	
	public LandValidationTask() {
	...
	public static boolean startJob() {
		landValidationJob = new LandValidationTask();

	...
	public static boolean createRegionDefinitionsFolderAndSampleFiles() {
		...
		try {
			...
			if (folderWasCreated) {
				...
				fileEntries.add("average_province_size: 80000");
				fileEntries.add("minimum_start_distance_between_brushes: 32");
				fileEntries.add("max_allowed_variance_between_ideal_and_actual_num_provinces: 0.1");
				fileEntries.add("brush_square_radius_in_chunks: 4");
				fileEntries.add("min_brush_move_amount_in_chunks: 1");
				fileEntries.add("max_brush_move_amount_in_chunks: 4");
				fileEntries.add("max_area_claimed_per_brush: 70000");
				...
				fileEntries.add("minimum_start_distance_between_brushes: 10");
				fileEntries.add("max_allowed_variance_between_ideal_and_actual_num_provinces: 0.1");
				fileEntries.add("brush_square_radius_in_chunks: 2");
				fileEntries.add("min_brush_move_amount_in_chunks: 1");
				fileEntries.add("max_brush_move_amount_in_chunks: 2");
				fileEntries.add("max_area_claimed_per_brush: 18000");
				fileEntries.add("max_brush_moves: 100");
